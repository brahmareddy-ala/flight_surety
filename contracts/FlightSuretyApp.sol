...
contract FlightSuretyApp {
    ...
    *
    */
    function registerAirline(string calldata name, address applicantAirline) external
    {
        flightSuretyData.registerAirline(msg.sender, name, applicantAirline);
    }
    ...
    *
    */
    /*function registerFlight(string calldata name, uint256 timestamp) external 
    {
        Flight memory flight = Flight(true, STATUS_CODE_ON_TIME, timestamp, msg.sender);
